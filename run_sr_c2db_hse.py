...
print("Starting Symbolic Regression for C2DB HSE Bandgap...")
...
for random_seed in range(100):
    ...
    # 使用清理后的C2DB HSE特征文件
    csv_file = 'c2db_hse_features_minimal.csv'
    output_train_file = f'c2db_hse_bandgap_train_{random_seed}.csv'
    output_test_file = f'c2db_hse_bandgap_test_{random_seed}.csv'
    ...
    # 保存结果
    np.save('test_result_dict_c2db_hse.npy', test_result_dict)
    
    print(f"Seed {random_seed} completed")

print("\nSymbolic Regression for C2DB HSE completed!")
print("Results saved to: test_result_dict_c2db_hse.npy")
